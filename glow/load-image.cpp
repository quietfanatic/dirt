...
AYU_DESCRIBE(sail_status_t,
    values(
        value("SAIL_OK", SAIL_OK),
         // Common errors.
        value("NULL_PTR", SAIL_ERROR_NULL_PTR),
        value("MEMORY_ALLOCATION", SAIL_ERROR_MEMORY_ALLOCATION),
        value("OPEN_FILE", SAIL_ERROR_OPEN_FILE),
        value("READ_FILE", SAIL_ERROR_READ_FILE),
        value("SEEK_FILE", SAIL_ERROR_SEEK_FILE),
        value("CLOSE_FILE", SAIL_ERROR_CLOSE_FILE),
        value("LIST_DIR", SAIL_ERROR_LIST_DIR),
        value("PARSE_FILE", SAIL_ERROR_PARSE_FILE),
        value("INVALID_ARGUMENT", SAIL_ERROR_INVALID_ARGUMENT),
        value("READ_IO", SAIL_ERROR_READ_IO),
        value("WRITE_IO", SAIL_ERROR_WRITE_IO),
        value("FLUSH_IO", SAIL_ERROR_FLUSH_IO),
        value("SEEK_IO", SAIL_ERROR_SEEK_IO),
        value("TELL_IO", SAIL_ERROR_TELL_IO),
        value("CLOSE_IO", SAIL_ERROR_CLOSE_IO),
        value("EOF", SAIL_ERROR_EOF),
        value("NOT_IMPLEMENTED", SAIL_ERROR_NOT_IMPLEMENTED),
        value("UNSUPPORTED_SEEK_WHENCE", SAIL_ERROR_UNSUPPORTED_SEEK_WHENCE),
        value("EMPTY_STRING", SAIL_ERROR_EMPTY_STRING),
        value("INVALID_VARIANT", SAIL_ERROR_INVALID_VARIANT),
         // Encoding/decoding common errors.
        value("INVALID_IO", SAIL_ERROR_INVALID_IO),
         // Encoding/decoding specific errors.
        value("INCORRECT_IMAGE_DIMENSIONS", SAIL_ERROR_INCORRECT_IMAGE_DIMENSIONS),
        value("UNSUPPORTED_PIXEL_FORMAT", SAIL_ERROR_UNSUPPORTED_PIXEL_FORMAT),
        value("INVALID_PIXEL_FORMAT", SAIL_ERROR_INVALID_PIXEL_FORMAT),
        value("UNSUPPORTED_COMPRESSION", SAIL_ERROR_UNSUPPORTED_COMPRESSION),
        value("UNSUPPORTED_META_DATA", SAIL_ERROR_UNSUPPORTED_META_DATA),
        value("UNDERLYING_CODEC", SAIL_ERROR_UNDERLYING_CODEC),
        value("NO_MORE_FRAMES", SAIL_ERROR_NO_MORE_FRAMES),
        value("INTERLACING_UNSUPPORTED", SAIL_ERROR_INTERLACING_UNSUPPORTED),
        value("INCORRECT_BYTES_PER_LINE", SAIL_ERROR_INCORRECT_BYTES_PER_LINE),
        value("UNSUPPORTED_IMAGE_PROPERTY", SAIL_ERROR_UNSUPPORTED_IMAGE_PROPERTY),
        value("UNSUPPORTED_BIT_DEPTH", SAIL_ERROR_UNSUPPORTED_BIT_DEPTH),
        value("MISSING_PALETTE", SAIL_ERROR_MISSING_PALETTE),
        value("UNSUPPORTED_FORMAT", SAIL_ERROR_UNSUPPORTED_FORMAT),
        value("BROKEN_IMAGE", SAIL_ERROR_BROKEN_IMAGE),
         // Codecs-specific errors.
        value("CODEC_LOAD", SAIL_ERROR_CODEC_LOAD),
        value("CODEC_NOT_FOUND", SAIL_ERROR_CODEC_NOT_FOUND),
        value("UNSUPPORTED_CODEC_LAYOUT", SAIL_ERROR_UNSUPPORTED_CODEC_LAYOUT),
        value("CODEC_SYMBOL_RESOLVE", SAIL_ERROR_CODEC_SYMBOL_RESOLVE),
        value("INCOMPLETE_CODEC_INFO", SAIL_ERROR_INCOMPLETE_CODEC_INFO),
        value("UNSUPPORTED_CODEC_FEATURE", SAIL_ERROR_UNSUPPORTED_CODEC_FEATURE),
        value("UNSUPPORTED_CODEC_PRIORITY", SAIL_ERROR_UNSUPPORTED_CODEC_PRIORITY),
         // libsail errors.
        value("ENV_UPDATE", SAIL_ERROR_ENV_UPDATE),
        value("CONTEXT_UNINITIALIZED", SAIL_ERROR_CONTEXT_UNINITIALIZED),
        value("GET_DLL_PATH", SAIL_ERROR_GET_DLL_PATH),
        value("CONFLICTING_OPERATION", SAIL_ERROR_CONFLICTING_OPERATION)
    )
)
...
AYU_DESCRIBE(SailPixelFormat,
    values(
        ...
        value("BPP32_YCCK", SAIL_PIXEL_FORMAT_BPP32_YCCK),
         // CIE LAB formats.
        value("BPP24_CIE_LAB", SAIL_PIXEL_FORMAT_BPP24_CIE_LAB), /* 8/8/8   */
        value("BPP40_CIE_LAB", SAIL_PIXEL_FORMAT_BPP40_CIE_LAB), /* 8/16/16 */
         // CIE LUV formats.
        value("BPP24_CIE_LUV", SAIL_PIXEL_FORMAT_BPP24_CIE_LUV), /* 8/8/8   */
        value("BPP40_CIE_LUV", SAIL_PIXEL_FORMAT_BPP40_CIE_LUV), /* 8/16/16 */
         // YUV formats.
        value("BPP24_YUV", SAIL_PIXEL_FORMAT_BPP24_YUV), /* 8-bit  */
        value("BPP30_YUV", SAIL_PIXEL_FORMAT_BPP30_YUV), /* 10-bit */
        value("BPP36_YUV", SAIL_PIXEL_FORMAT_BPP36_YUV), /* 12-bit */
        value("BPP48_YUV", SAIL_PIXEL_FORMAT_BPP48_YUV), /* 16-bit */
