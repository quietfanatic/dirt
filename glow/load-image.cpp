...
constexpr FormatInfo formats [n_formats] = {
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_UNKNOWN
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP1
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP2
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP4
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP8
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP16
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP24
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP32
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP48
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP64
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP72
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP96
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP128
    {FT::Indexed,0,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP1_INDEXED
    {FT::Indexed,0,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP2_INDEXED
    {FT::Indexed,0,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP4_INDEXED
    {FT::Indexed,0,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP8_INDEXED
    {FT::Indexed,0,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_INDEXED
    {FT::Convert,GL_R8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP1_GRAYSCALE
    {FT::Convert,GL_R8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP2_GRAYSCALE
    {FT::Convert,GL_R8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP4_GRAYSCALE
    {FT::Normal,GL_R8,GL_RED,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP8_GRAYSCALE
    {FT::Normal,GL_R8,GL_RED,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP16_GRAYSCALE
    {FT::Convert,GL_RG8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP4_GRAYSCALE_ALPHA
    {FT::Convert,GL_RG8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP8_GRAYSCALE_ALPHA
    {FT::Normal,GL_RG8,GL_RG,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_GRAYSCALE_ALPHA
    {FT::Normal,GL_RG8,GL_RG,GL_UNSIGNED_INT}, // _PIXEL_FORMAT_BPP32_GRAYSCALE_ALPHA
    {FT::Normal,GL_RGB5,GL_RGB,GL_UNSIGNED_SHORT_5_5_5_1}, // _PIXEL_FORMAT_BPP16_RGB555
    {FT::Normal,GL_RGB5,GL_BGR,GL_UNSIGNED_SHORT_5_5_5_1}, // _PIXEL_FORMAT_BPP16_BGR555
    {FT::Normal,GL_RGB8,GL_RGB,GL_UNSIGNED_SHORT_5_6_5}, // _PIXEL_FORMAT_BPP16_RGB565
    {FT::Normal,GL_RGB8,GL_BGR,GL_UNSIGNED_SHORT_5_6_5}, // _PIXEL_FORMAT_BPP16_BGR565
    {FT::Normal,GL_RGB8,GL_RGB,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP24_RGB
    {FT::Normal,GL_RGB8,GL_BGR,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP24_BGR
    {FT::Normal,GL_RGB8,GL_RGB,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP48_RGB
    {FT::Normal,GL_RGB8,GL_BGR,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP48_BGR
    {FT::Normal,GL_RGB4,GL_RGBA,GL_UNSIGNED_SHORT_4_4_4_4}, // _PIXEL_FORMAT_BPP16_RGBX
    {FT::Normal,GL_RGB4,GL_BGRA,GL_UNSIGNED_SHORT_4_4_4_4}, // _PIXEL_FORMAT_BPP16_BGRX
    {FT::Convert,GL_RGB4,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_XRGB
    {FT::Convert,GL_RGB4,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_XBGR
    {FT::Normal,GL_RGBA4,GL_RGBA,GL_UNSIGNED_SHORT_4_4_4_4}, // _PIXEL_FORMAT_BPP16_RGBA
    {FT::Normal,GL_RGBA4,GL_BGRA,GL_UNSIGNED_SHORT_4_4_4_4}, // _PIXEL_FORMAT_BPP16_BGRA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_ARGB
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP16_ABGR
    {FT::Normal,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_RGBX
    {FT::Normal,GL_RGB8,GL_BGRA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_BGRX
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_XRGB
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_XBGR
    {FT::Normal,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_RGBA
    {FT::Normal,GL_RGBA8,GL_BGRA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_BGRA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_ARGB
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_ABGR
    {FT::Normal,GL_RGB8,GL_RGBA,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP64_RGBX
    {FT::Normal,GL_RGB8,GL_BGRA,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP64_BGRX
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_XRGB
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_XBGR
    {FT::Normal,GL_RGBA8,GL_RGBA,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP64_RGBA
    {FT::Normal,GL_RGBA8,GL_BGRA,GL_UNSIGNED_SHORT}, // _PIXEL_FORMAT_BPP64_BGRA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_ARGB
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_ABGR
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_CMYK
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_CMYK
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP40_CMYKA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP80_CMYKA
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP24_YCBCR
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_YCCK
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP24_CIE_LAB
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP40_CIE_LAB
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP24_CIE_LUV
    {FT::Unsupported,0,0,0}, // _PIXEL_FORMAT_BPP40_CIE_LUV
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP24_YUV
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP30_YUV
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP36_YUV
    {FT::Convert,GL_RGB8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP48_YUV
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP32_YUVA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP40_YUVA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP48_YUVA
    {FT::Convert,GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE}, // _PIXEL_FORMAT_BPP64_YUVA
};
